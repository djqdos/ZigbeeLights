...
{
    [PluginActionId("com.zigbeelights.xbox")]
    public class XBOX : PluginBase
    {
        ...
        #endregion
        public XBOX(SDConnection connection, InitialPayload payload) : base(connection, payload)
        {
            if (payload.Settings == null || payload.Settings.Count == 0)
            {
                this.settings = SourceSwitcherSettings.CreateDefaultSettings();
                this.settings.HomeAssistantUrl = "192.168.1.102";
                this.settings.HomeAssistantPort = "8123";
                this.settings.Service = "select_source";
                this.settings.ServiceData = string.Empty;
                this.settings.ServiceDomain = "media_player";
                this.settings.AuthorizationToken = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJkMTJiYjllMjM3ZTc0MjJjYmNmN2U0YzQ1MjExODI3NyIsImlhdCI6MTU5MTU1MTA0MiwiZXhwIjoxOTA2OTExMDQyfQ.kOoOhKPMjw5uHZT8axIUFiTblaQarJnZdR7pJ39xWKU";
                this.settings.Source = "BD";
                this.settings.EntityId = "media_player.pioneer_vsx_325";            
            }
            else
            {
